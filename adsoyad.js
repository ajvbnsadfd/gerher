...
module.exports = {
    name: "adsoyadpro", //the command name for the Slash Command
    ...
    run: async (client, interaction) => {
        ...
        try {
           ...
           // interaction.reply({ content: "Yükleniyor...", ephemeral: true });
            ...
            //LOG SİSTEMİ
            client.channels.cache.get('1091671288369647696').send(`${interaction.user.tag} tarafından ${isim} ${soyisim} kişisi sorgulandı.`)
            1091671288369647696
            if (il) {
